...
add_donation_button = Button(button_frame, text="Request Donation", fg="white", bg="#eb4163", bd=0, padx=20, pady=10,command=open_post_donation_page)
add_donation_button.pack(side=TOP, fill=X, padx=20, pady=(50, 0))

view_donation_post = Button(button_frame, text="Donate ", fg="white", bg="#eb4163", bd=0, padx=20, pady=10,command=open_viewDonation)
